      ...
      <div className='bg-white shadow-lg p-5 rounded-xl h-[27rem] w-[20rem] flex flex-col justify-center items-center' >
        <div className='mb-10 '>
          ...
          <p className='text-center text-sm text-gray-400' >
            Welcome , create a account to continue </p>
        </div>
        ...
        <div className="w-full">
          <button disabled={isloading} onClick={handleAuth} className='bg-[#01aa85] text-white font-bold w-full p-2 rounded-md flex items-center gap-2 justify-center cursor-pointer ' >
           {isloading ? (
            <> Processing...
            </>
           ):
